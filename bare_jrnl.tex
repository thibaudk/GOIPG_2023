...
% How can we interact with open ended, abstract software on finite physical interfaces ? More specifically, how can graphical representation of time translate to hardware interfaces, and what would such a translation entail for interacting with different temporal modals ? This question is particularly delicate with software straying far away from the norm, and hardware interfaces incarnating conventions in musical expression. 
